...
('CASO00001', '2023-01-15', '2023-06-15', FALSE, 'C00001'),
('CASO00002', '2023-02-10', '2023-07-20', FALSE, 'C00001'),
('CASO00003', '2023-03-05', '2024-01-15', FALSE, 'C00001'),
('CASO00004', '2023-04-01', NULL, TRUE, 'C00002'),
('CASO00005', '2023-05-12', NULL, TRUE, 'C00003');

-- Inserciones para DIRECCION_CASO.
INSERT INTO DIRECCION_CASO (id_caso, id_procurador, ganado) VALUES
('CASO00001', 'P00001', TRUE),
('CASO00002', 'P00002', FALSE),
('CASO00003', 'P00003', TRUE),
('CASO00004', 'P00004', NULL),
('CASO00005', 'P00005', NULL);
