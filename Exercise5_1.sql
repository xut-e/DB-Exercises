...
CREATE TABLE DIRECCION_CASO (
    id_caso VARCHAR(15),
    FOREIGN KEY (id_caso) REFERENCES CASO(id_caso) ON DELETE SET NULL ON UPDATE CASCADE,
    id_procurador VARCHAR(9),
    FOREIGN KEY (id_procurador) REFERENCES PROCURADOR(id_procurador) ON DELETE SET NULL ON UPDATE CASCADE,
    ganado BOOLEAN
);
