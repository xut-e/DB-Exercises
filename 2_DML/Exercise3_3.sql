...
SELECT ASIGNATURA.nombre AS nombre_asignatura, COUNT(MATRICULA.id_matricula) AS numero_alumnos FROM ASIGNATURA LEFT JOIN MATRICULA ON ASIGNATURA.id_asignatura = MATRICULA.id_asignatura GROUP BY ASIGNATURA.nombre;